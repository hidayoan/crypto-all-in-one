...
export const caculateAPR = (tokenPerSecond = 0, totalStake = 0, type = 'BONE') => {
  if (type === 'BONE') {
...
export const caculateYieldAPR = (tokenPerSecond = 0, totalStake = 0, type = 'eth') => {
...
export function roundDown(number = 0, decimalPlaces = 0) {

  const factor = 10 ** decimalPlaces;
  return Math.floor(number * factor) / factor;
}

export function formatNumber(val = '0', minimumFractionDigits = 2, maximumFractionDigits = 2) {
...
export const checkNativeToken = (val = '') => {
